...
//    @Test
//    @WithMockUser(username = "user", password = "111", roles = "USER")
//    void createTeacherRestNegativeTest() throws Exception {
//        Teacher teacher = new Teacher();
//        teacher.setFirstName("NewFirstname");
//        teacher.setLastName("NewLastname");
//        teacher.setTeachEmail("NEWTEACHEMAIL@YAHOO.COM");
//        String newStringTeacher = objectMapper.writeValueAsString(teacher);
//
//        MvcResult createDuplicateCustomerResult = mockMvc
//                .perform(MockMvcRequestBuilders
...
//                .andReturn();
//
//        assertEquals(400, createDuplicateCustomerResult.getResponse().getStatus());
//        String errorMessage = createDuplicateCustomerResult.getResolvedException().getMessage();
//        assertTrue(errorMessage.contains("Customer with this email already exists"));
//    }
